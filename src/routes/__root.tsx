...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Demo Restaurant — BBQ · Chinese · Continental · Pakistani · Shakargarh" },
      { property: "og:title", content: "Demo Restaurant — BBQ · Chinese · Continental · Pakistani · Shakargarh" },
      { name: "twitter:title", content: "Demo Restaurant — BBQ · Chinese · Continental · Pakistani · Shakargarh" },
